...
dosyaIcerigi.then((sonuc) => print("$sonuc")); // return yapıldıktan sonra bu satır çalıştırılır
...
print("Dosya içeriği gösterilecek");
String dosyaIcerigi = await dosyaIndir(); // Bu işlem ana senkronun dışına çıkarak işlem tamamlanasıya kadar "thread" e benzer yapıda arkaplanda çalıştırılır.
print("DOSYA İÇERİĞİ >>>  $dosyaIcerigi");
